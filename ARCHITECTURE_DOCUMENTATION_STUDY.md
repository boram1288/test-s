...
![하나의 시스템을 서로 다른 뷰타입으로 분리한 예시](diagrams/01-viewtypes.png)
...
![온라인 서점의 런타임 상호작용 예시](diagrams/03-runtime-view.png)
...
![온라인 서점의 배포 할당 예시](diagrams/04-deployment-view.png)
...
![같은 시스템의 뷰 간 비대칭 대응 예시](diagrams/09-three-viewtypes-simple.png)
...
![목적에 따라 화살표 의미를 구분한 예시](diagrams/07-avoid-ambiguous-arrows.png)
...
![주문 처리 대표 시나리오 예시](diagrams/06-order-sequence.png)
