...
```plantuml
!include diagrams/08-why-multiple-views.puml
```
...
```plantuml
!include diagrams/01-viewtypes.puml
```
...
```plantuml
!include diagrams/03-runtime-view.puml
```
...
```plantuml
!include diagrams/04-deployment-view.puml
```
...
```plantuml
!include diagrams/09-three-viewtypes-simple.puml
```
...
```plantuml
!include diagrams/10-select-views-simple.puml
```
...
```plantuml
!include diagrams/11-clear-arrows-simple.puml
```

> **표기법은 뷰의 목적에 필요한 차이만 명확히 드러내야 한다.**

```plantuml
!include diagrams/07-avoid-ambiguous-arrows.puml
```
...
```plantuml
!include diagrams/12-behavior-simple.puml
```
...
```plantuml
!include diagrams/06-order-sequence.puml
```
...
```plantuml
!include diagrams/13-documentation-loop-simple.puml
```
